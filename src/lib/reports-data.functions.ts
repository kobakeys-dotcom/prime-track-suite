...
const MODULE_CONFIG: Record<string, {
  ...
  drawings: { label: "Drawings", category: "Drawings", dateCol: "created_at",
    select: "id, drawing_number, title, discipline, status",
    columns: [{ key: "drawing_number", label: "#" }, { key: "title", label: "Title" }, { key: "discipline", label: "Discipline" }, { key: "status", label: "Status" }]},

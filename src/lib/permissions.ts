...
const MATRIX: Record<AppRole, Partial<Record<Module, Action[]>>> = {
  ...
  planning_engineer: { projects: ["view"], tasks: ALL, daily_reports: ["view"], boq: ["view"], drawings: ["view"], documents: ["view"], meetings: ["view","create","edit"], milestones: ALL, reports: ALL, ai: ALL },
  ...
  procurement_officer: { projects: ["view"], procurement: ALL, suppliers: ALL, rfis: ["view"], documents: ["view","create"], reports: ["view"], ai: ALL },
